...
CREATE TABLE IF NOT EXISTS word_of_the_day (
    ...
    source_type VARCHAR(20) NOT NULL CHECK (source_type IN ('vocabulary_question', 'snippet')),
...
ALTER TABLE users ADD COLUMN IF NOT EXISTS word_of_day_email_enabled BOOLEAN DEFAULT FALSE;
