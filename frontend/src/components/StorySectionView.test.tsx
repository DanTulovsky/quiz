...
describe('StorySectionView', () => {
  ...
  describe('TTS Functionality', () => {
    ...
    it('calls stopTTS when TTS button is clicked while playing', async () => {
      ...
      // Get the section content that will be played
      const sectionContent = defaultProps.section?.content || '';

      // Set up initial playing state
      mockTTS.isPlaying = true;
      mockTTS.currentPlayingText = sectionContent.trim();
      mockTTS.currentKey = sectionContent.trim();
      mockTTS.isLoading = false;
