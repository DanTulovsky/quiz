...
export const getGetV1WordOfDayDateEmbedQueryOptions = <TData = Awaited<ReturnType<typeof getV1WordOfDayDateEmbed>>, TError = string | string | string>(date: string, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getV1WordOfDayDateEmbed>>, TError, TData>>, }
) => {
