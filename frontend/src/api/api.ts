...
export type PostV1StoryIdArchiveBody = { [key: string]: unknown };
...
export const postV1StoryIdArchive = (
    id: number,
    postV1StoryIdArchiveBody?: PostV1StoryIdArchiveBody,
 options?: SecondParameter<typeof customInstance>,signal?: AbortSignal
) => {
      
      
      return customInstance<void>(
      {url: `/v1/story/${id}/archive`, method: 'POST',
      headers: {'Content-Type': 'application/json', },
      data: postV1StoryIdArchiveBody, signal
    },
      options);
    }
...
export const getPostV1StoryIdArchiveMutationOptions = <TError = ErrorResponse,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postV1StoryIdArchive>>, TError,{id: number;data: PostV1StoryIdArchiveBody}, TContext>, request?: SecondParameter<typeof customInstance>}
): UseMutationOptions<Awaited<ReturnType<typeof postV1StoryIdArchive>>, TError,{id: number;data: PostV1StoryIdArchiveBody}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof postV1StoryIdArchive>>, {id: number;data: PostV1StoryIdArchiveBody}> = (props) => {
          const {id,data} = props ?? {};

          return  postV1StoryIdArchive(id,data,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type PostV1StoryIdArchiveMutationBody = PostV1StoryIdArchiveBody
...
export const usePostV1StoryIdArchive = <TError = ErrorResponse,
 ...
 , queryClient?: QueryClient): UseMutationResult<
        ...
        TError,
        {id: number;data: PostV1StoryIdArchiveBody},
        TContext
      > => {
