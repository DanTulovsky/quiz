...
declare module '@tabler/icons-react' {
  ...
  export const IconLock: React.ComponentType<any>;
  export const IconSearch: React.ComponentType<any>;
  export const IconEdit: React.ComponentType<any>;
  export const IconTrash: React.ComponentType<any>;
  export const IconPlus: React.ComponentType<any>;
  export const IconExternalLink: React.ComponentType<any>;
  export const IconLanguage: React.ComponentType<any>;
  export const IconRobot: React.ComponentType<any>;
  export const IconRobotOff: React.ComponentType<any>;
  export const IconChevronsLeft: React.ComponentType<any>;
  export const IconChevronsRight: React.ComponentType<any>;
  export const IconChevronDown: React.ComponentType<any>;
  export const IconChevronUp: React.ComponentType<any>;
  export const IconHome: React.ComponentType<any>;
  export const IconTrophy: React.ComponentType<any>;
  export const IconArrowLeft: React.ComponentType<any>;
  export const IconAlertCircle: React.ComponentType<any>;
  export const IconCopy: React.ComponentType<any>;
  export const IconDownload: React.ComponentType<any>;
  export const IconHash: React.ComponentType<any>;
  export const IconPrinter: React.ComponentType<any>;
  export const IconSelector: React.ComponentType<any>;
